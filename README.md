...
| Código implementa corretamente as fases do semáforo e estrutura do código (variáveis representativas e comentários) | Até 3              | Até 1,5                          | 0                        |  Nota: 3 - O código está completo e foi além, adicionando funcionalidades mais complexas                         |
| Extra: Implmeentou um componente de liga/desliga no semáforo e/ou usou ponteiros no código | Até 1              |  Até 0,5                         | 0                        |  Nota: 1 - A aluna implementou um botão para a passagem de pedestres                         |
|  |                                                             |  | |*Pontuação Total: 10*|
